# System Prompt Contract: TaskBot Agent Behavior

**Feature**: Chunk 6 - Agent Behavior | **Date**: 2026-01-17

This document contains the complete system prompt for the TaskBot Gemini agent. This is the authoritative contract for agent behavior.
...
| Intent Examples | 16 phrasings |
| Error Templates | 7 messages |
...
# Or inline in backend/src/services/agent.py
```
...
- [X] Persona section defines TaskBot identity
- [X] All 5 task operations listed in Capabilities
- [X] Confirmation templates for all operations
- [X] Error messages use romanized Urdu
- [X] Multi-step reasoning rules for ambiguous references
- [X] Language adaptation rules for English/Urdu
- [X] Conversational responses for greetings/help
- [X] Context awareness for pronoun resolution
- [X] Constraints section prevents bad behaviors
- [X] No technical jargon in any user-facing text

**Verification Status**: PASSED (2026-01-18)
